...
const Layout = {
            ...
            <div class="sidebar">
                ...
                <nav class="sidebar-nav">
                    <div class="nav-section">
                        ...
                        <!-- KPI's escondido — KPIs operacionais agora ficam na seção do objetivo
    ...
    async navigate(page, updateURL = true) {
        ...
        const isAdmin = AuthService.isAdmin();
        const canAccessApproval = AuthService.canAccessApproval();
        const adminOnlyPages = ['users', 'departments', 'company-policy', 'problem-tree', 'swot-matrix', 'impact-definition', 'scenario-analysis'];
